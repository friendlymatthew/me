...
export default function Home() {
	...
	return (
		<div className="text-[#123693] tracking-tighter font-medium font-opensans">
			<Head>
				<title>whoami?</title>
			...
			<section className="grid grid-cols-1 place-items-center">
				<div className="w-7/12 text-3xl py-16">
					<span>
						<span>
						...
						<Link href="/proof">
							<span className="font-normal text-base cursor-pointer hover:underline underline-offset-2">
								Proof
							</span>
						</Link>
					</span>

					<div className="text-xl font-normal mt-8 grid lg:grid-cols-4 grid-cols-1">
								...
								return (
									<div className="my-1 " key={name}>
										...
										<ul className="font-normal">
											{things.map(({ thing }) => {
												return (
													<li key={thing} className="text-base">
														{thing}
													</li>
												);
											})}
				...
				<div className="bg-[#ffeacc] flex justify-center text-xl font-normal">
					<div className="w-7/12 py-16 grid grid-col-1 lg:gap-y-0 gap-y-4 lg:gap-x-12 lg:grid-cols-2">
